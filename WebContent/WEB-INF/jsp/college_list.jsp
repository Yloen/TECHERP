...
<body>
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 学院管理 <span
            class="c-gray en">&gt;</span> 学院列表 <a class="btn btn-success radius r"
    ...
    <div class="page-container">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l">
				...
				<a class="btn btn-primary radius" data-title="添加学院" data-href="article-add.html"
                    onclick="Hui_admin_tab(this)" href="javascript:;">
					<i class="Hui-iconfont">&#xe600;</i>添加学院
				</a>
			</span>
			<span class="r">共有数据：<strong>000</strong> 条</span></div>
        <div class="mt-20">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="text-l">
                            <u style="cursor:pointer" class="text-primary"
                                onClick="article_edit('查看','article-zhang.html','10001')" title="查看">四川交通职业技术学院</u>
                        </td>
                        <td>http://www.svtcc.edu.cn/</td>
                        <td>四川省成都市温江区</td>
                        <td>2611130</td>
                        <td>21212</td>

...
<body>
	<div class="cl pd-20" style="background-color: #5bacb6">
		 <img class="avatar size-XL l" src="${pageContext.request.contextPath}/images/${content.getPicSrc()}">

		<dl style="margin-left: 80px; color: #fff">
			<dt>
				<span class="f-18">标题：${content.getTopic()}</span> <span
					class="pl-10 f-12">作者：${content.getAuthor()}</span>
			</dt>
			<dd class="pt-10 f-12" style="margin-left: 0">发布时间：${content.getPublicDate()}</dd>
		</dl>
	</div>
	<div class="pd-20">
		<table class="table">

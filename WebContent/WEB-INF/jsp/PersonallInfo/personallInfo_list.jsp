...
<body>
	...
	<span class="c-gray en">&gt;</span> 信息管理 <span class="c-gray en">&gt;</span>
	个人信息列表 <a class="btn btn-success radius r"
	...
	<div class="page-container">
		<div class="text-c">
			...
			<form id="search_name">
				<input type="text" class="input-text" style="width: 250px"
					placeholder="输入用户名称" id="Name" name="Name">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="delect_batch()"
				...
				onclick="member_add('信息添加','${pageContext.request.contextPath}/PersonallInfo/Person_Add','','510')"
				class="btn btn-primary radius"> <i class="Hui-iconfont">&#xe600;</i>
					添加用户
			</a> </span> <span class="r">共有用户：<strong>888</strong> 名
			</span>
		</div>
		<div class="mt-20">
			<table id="datalist"
				...
				<tbody>
					...
					<c:forEach items="${sessionScope.personallInfolist}" var="personallInfo">
						<tr class="text-c">
  ...
  function member_del(obj, id) {
    layer.confirm('确认要删除吗？', function (index) {
      $.ajax({
        type: 'POST',
        url: '${pageContext.request.contextPath}/PersonallInfo/Person_Delete?PersonalId='+id,
        dataType: 'json',
        success: function (data) {
 ...
 function delect_batch(){ 
   ...
   console.log("选中值："+ ids);
     ...
     if (confirm("是否 删除?")){
       $.post ("${pageContext.request.contextPath}/PersonallInfo/Person_DeleteBatch", {"ids":ids},
       function (data){
      if (data>0) {
         alert("not ok");
          }else {
...
$("#search").click(function() {
	  $.ajax({
          ...
          url : "${pageContext.request.contextPath}/PersonallInfo/Person_FindLike",//请求的action路径  

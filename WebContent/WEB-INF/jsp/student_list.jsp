...
<nav class="breadcrumb">
	<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 学生管理
...
<div class="page-container">
  <div class="text-c">
    <input type="text" class="input-text" style="width:250px" placeholder="输入学生姓名进行查找" id="" name="">
  ...
  <div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<span class="r">共有学生：<strong>88</strong> 名</span></div>
  <div class="mt-20">
...
<!--        <th width="70">状态</th>-->
      ...
      <tr class="text-c">
        ...
        <td><u style="cursor:pointer" class="text-primary"
               onclick="member_show('学生详细信息','${pageContext.request.contextPath}/student_show.do','10001','360','400')">王彪</u></td>
        <td>2018</td>
        <td>男</td>
        <td class="text-l">软件技术</td>
        <td>在校</td>
        <td class="text-l">11111111111111</td>
        <td >软件18-3</td>

...
<body>
	<nav class="breadcrumb"> <i class="Hui-iconfont">&#xe67f;</i> 权限系统
	<span class="c-gray en">&gt;</span> 权限管理 <span class="c-gray en">&gt;</span>
	...
	<div class="page-container">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			</span> <span class="r">共有用户：<strong>88</strong> 名
			</span>
		</div>
		<div class="mt-20">
			<table id="datalist"
               ...
               onclick="member_show('${user.getUserId()}','${pageContext.request.contextPath}/User/User_show?UserId=${user.getUserId()}','10001','360','400')">${user.getUserId()}</u>
							</td>
					 	<td>${user.getIdentityName()}
					 	
					 	
					 	</td> 	
							<td class="td-manage"><a
								title="修改权限" href="javascript:;"
								onclick="member_edit('修改权限','${pageContext.request.contextPath}/Role/Role_show?UserId=${user.getUserId()}','3','','250')"

...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="${pageContext.request.contextPath}/teacher.do" data-title="教师列表" href="javascript:;">教师列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
    ...
    <div class="menu_dropdown bk_2" style="display:none">
        <dl id="menu-bbbbb">
            <dt><i class="Hui-iconfont">&#xe616;</i> 招生管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="admissions-announcement.html" data-title="招生公告" href="javascript:void(0)">招生公告</a></li>
                    <li><a data-href="admissions-talent.html" data-title="人才培养方案" href="javascript:void(0)">人才培养方案</a></li>
                </ul>
            </dd>
        </dl>
		<dl id="menu-bbbbb">
			<dt><i class="Hui-iconfont">&#xe616;</i> 普通高考<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="admissions-general-policy.html" data-title="招生政策" href="javascript:void(0)">招生政策</a></li>
					<li><a data-href="admissions-general-plan.html" data-title="招生计划" href="javascript:void(0)">招生计划</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-bbbbb">
			<dt><i class="Hui-iconfont">&#xe616;</i> 单独招生<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="admissions-single-policy.html" data-title="招生政策" href="javascript:void(0)">招生政策</a></li>
					<li><a data-href="admissions-single-plan.html" data-title="招生计划" href="javascript:void(0)">招生计划</a></li>
				</ul>
			</dd>
		</dl>
    </div>
    ...
    <div class="menu_dropdown bk_2" style="display:none">
        <dl id="menu-ccccc">
            <dt><i class="Hui-iconfont">&#xe616;</i> 就业管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="employment-announcement.html" data-title="就业公告" href="javascript:void(0)">就业公告</a></li>
                    <li><a data-href="employment-guide.html" data-title="就业指导" href="javascript:void(0)">就业指导</a></li>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="${pageContext.request.contextPath}/welcome.do">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="${pageContext.request.contextPath}/welcome.do"></iframe>
        </div>
    </div>
</section>
